        ...
        tableIns = table.render({
            ...
            , cols: [[{type: 'checkbox'}
                , {
                    ...
                    sort: true,
                    templet: function (d) {
                        var icon = "<a lay-href='/views/home/onlineVideo.jsp?"+d.file_url+"'><i class='fa fa-file-video-o' style='font-size:18px;color:rgb(129,131,241);margin:8px 5px 0 0'></i>"+d.fileName+"</a>";
                        console.log(d);
                        return icon;
                    }
                }
